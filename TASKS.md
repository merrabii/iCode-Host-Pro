...
- [~] **Observation** : la row `Deployment` reste `DEPLOYING` quand l'Order est `ACTIVE` (le proof-gate finalise l'Order). À trancher : aligner `Deployment`→ACTIVE au passage du gate ? Non modifié.
- [x] **Pas de push** : 3 commits locaux (`7490de1` · `528d1b9` · `555b808`), attente validation GO.
