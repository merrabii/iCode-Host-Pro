...
## Current state (Phase 2 — COMPLETE and owner-validated 2026-08-31)
...
- **`/manager`** admin console (list/create/delete servers & products), ADMIN-gated; token minted from refresh cookie, none in localStorage.
...
- Dev servers running in background: api on :3001 (`dev`, b9wlzepw2), web on :3000 (`dev`, bg6xsky8p).

Reported decisions: ADR-001..005 + 011..014 APPROVED (Phase 0); ADR-015 + 016 APPROVED (Phase 1); **ADR-017 APPROVED (Phase 2)**; ADR-006 full, 007, 008, 009, 010 stay PROPOSED.
